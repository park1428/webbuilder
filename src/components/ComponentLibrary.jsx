                ...
                {filteredBuiltin.filter(c => c.category === category).map(component => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <span className="component-card-drag-hint">⠿</span>
                    </button>
                  );
                })}
              </div>
      ...
      {expanded && (
        <div className="cl-community-preview">
          <iframe
            ...
            srcDoc={`<!DOCTYPE html><html><head><meta charset="UTF-8"><style>*,*::before,*::after{box-sizing:border-box}body{margin:0;padding:0;overflow:hidden;background:white;font-family:system-ui,-apple-system,sans-serif}</style></head><body>${sanitizeHTML(component.content)}</body></html>`}
            scrolling="no"
