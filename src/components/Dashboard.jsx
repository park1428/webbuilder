    ...
    <div className="dashboard">
      <aside className="dashboard-sidebar">
        <div className="sidebar-brand">
          <div className="sidebar-logo-mark">WB</div>
      ...
      <main className="dashboard-main">
        ...
        <div className="dashboard-stats">
          ...
          <div className="stat-item">
            <span className="stat-value">{projects.filter(p => Date.now() - new Date(p.updatedAt) < 7 * 86400000).length}</span>
                ...
                <div className="project-thumbnail">
                  {project.content
                    ? <iframe
                        ...
                        srcDoc={`<!DOCTYPE html><html><head><meta charset="UTF-8"><style>*{box-sizing:border-box}body{margin:0;overflow:hidden}</style></head><body>${project.content}</body></html>`}
                        scrolling="no"
