...
const TUTORIAL_STEPS = [
    ...
    content: (
      <>
        ...
        <ul className="tutorial-list">
          ...
          <li><strong>Design Tab:</strong> Get suggestions to improve your design</li>
        </ul>
  ...
  },
  {
    ...
    subtitle: 'Get design suggestions',
    content: (
      <>
        <p>The <strong>Design tab</strong> analyzes your website and suggests improvements:</p>
        <ul className="tutorial-list">
    ...
    content: (
      <>
        ...
        <ol className="tutorial-list tutorial-numbered">
          ...
          <li>Use the Design tab for design suggestions</li>
