    ...
    <div className="login-screen">
      <div className="login-left">
        <div className="login-brand">
          <div className="login-logo-mark">WB</div>
          <h1>WebBuilder</h1>
        </div>
        <div className="login-hero">
          <h2>Your ideas, built into real pages.</h2>
          <p>A visual editor for designers, marketers, and founders. Pick a layout, make it yours, download when ready.</p>
        </div>
