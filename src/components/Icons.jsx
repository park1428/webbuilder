...
export const Icons = {
  ...
  Party: (props) => (
    <svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" {...props}>
      ...
      <path d="m22 13-.82-.33c-.86-.34-1.82.2-1.98 1.11-.11.63-.76 1.03-1.38.88-.71-.17-1.28.56-1.02 1.24l.77 2"/>
      <path d="M7.5 10.5 12 6"/>
      <circle cx="10.5" cy="10.5" r="0.5" fill="currentColor"/>
      <circle cx="8.5" cy="14" r="0.5" fill="currentColor"/>
      <circle cx="11.5" cy="17" r="0.5" fill="currentColor"/>
    </svg>
  ),
  ...
  // Empty state icons
  Click: (props) => (
    <svg width="44" height="44" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" {...props}>
      <path d="M9 9h.01"/>
      <path d="M15 15V9h-6v6h6Z"/>
      <path d="m13 15 8 8"/>
      <path d="m21 21-2-2"/>
    </svg>
  ),
  ...
  Dot: (props) => (
    <svg width="8" height="8" viewBox="0 0 24 24" fill="currentColor" {...props}>
  ...
  StarFilled: (props) => (
    <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
      <polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/>
    </svg>
  ),
